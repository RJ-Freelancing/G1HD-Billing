      ...
      steps {
        ...
        script {
          try {
            ...
            sh 'cd server && docker run --name=server-container --link mongo-testing:mongo -e API_PORT=3001 -e JWT_SECRET=testing -e MONGO_URL=mongodb://mongo/g1hd server-test'
